...
<div class = "container">
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 add-margin-b2">
				...
				<form:form action="validar-registrar-usuario" method="POST" modelAttribute="datosLogin">
					...
					<button class="btn btn-lg btn-primary btn-block add-margin-b2" Type="Submit"/>Registrarme</button>
				</form:form>
